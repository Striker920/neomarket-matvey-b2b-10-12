...
class ProductService:
    ...
    def get_seller_products_list(
        ...
        """Seller cabinet: all statuses, with skus_count and total_active_quantity.
        
        Если include_deleted=False (по умолчанию) — возвращает только неудалённые товары.
        Если include_deleted=True — возвращает все, включая удалённые.
        """
